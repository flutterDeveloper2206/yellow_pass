...
ColorScheme flexSchemeDark = const ColorScheme(
  ...
  onSecondaryFixed: Color(0xff232323),
  surfaceContainer: Color(0xff808080),
  surfaceContainerHigh: Color(0xff000000),
  scrim: Color(0xffD0D0D0),

  //#e8e8e8

  tertiary: Color(0xff070707),
  onTertiary: Color(0xff000000),
  tertiaryContainer: Color(0xff132235),
  onTertiaryFixedVariant: Color(0xff333333),
  onTertiaryFixed: Color(0xff696969),
  ...
  onError: Color(0xffE94B3E),
  surface: Color(0xffffffff),
  tertiaryFixed: Color(0xff00D1FF),
