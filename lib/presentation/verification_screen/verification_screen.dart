...
class VerificationScreen extends GetView<VerificationController> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              Obx(() => _buildVerificationItem(context,
                  icon: Icons.email_outlined,
                  title: "Verify Email ID",
                  status: (controller.userData['is_email_verified'] == true ||
                      controller.userData['is_email_verified'] == 1),
              ...
              Obx(() => _buildVerificationItem(context,
                  ...
                  status: (controller.userData['is_mobile_verified'] == true ||
                      controller.userData['is_mobile_verified'] == 1),
              ...
              TextButton(
                onPressed: () {
                  Get.offAllNamed(
                      AppRoutes.dashboardScreenRoute); // Or home route
                },
                child: Text(
                  "Go to Home page",
                  style: PMT.style(14,
  ...
  Widget _buildProfileHeader(
      BuildContext context, Color textColor, Color subTextColor, bool isDark) {
    return Column(
      children: [
        Obx(() => Container(
              ...
              child: CircleAvatar(
                radius: 50,
                backgroundImage: (controller.userData['profile_picture'] !=
                            null &&
                        controller.userData['profile_picture']
                            .toString()
                            .isNotEmpty)
                    ? NetworkImage("${controller.userData['profile_picture']}")
                        as ImageProvider
  ...
  Widget _buildVerificationItem(BuildContext context,
    ...
    return Container(
      ...
      child: ListTile(
        ...
        trailing: Icon(status ? Icons.check_circle_outline : Icons.info_outline,
            size: 20,
            color: status ? Colors.green : ColorConstant.primaryColor),
